...
const Meta = () => {
    return (
        <>
            ...
            <title>Abdul Hafizh Kustiawan (@abdulhafizh_k), a full stack web developer</title>
            <meta title="Abdul Hafizh Kustiawan (@abdulhafizh_k), a full stack web developer" name="title" />
